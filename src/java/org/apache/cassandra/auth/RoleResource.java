...
public class RoleResource implements IResource, Comparable<RoleResource>
{
    ...
    public static final Set<IPermission> ROOT_LEVEL_PERMISSIONS = ImmutableSet.of(Permission.CREATE,
                                                                                   Permission.ALTER,
                                                                                   Permission.DROP,
                                                                                   Permission.AUTHORIZE,
                                                                                   Permission.DESCRIBE);
    // permissions which may be granted on role level resources
    public static final Set<IPermission> ROLE_LEVEL_PERMISSIONS = ImmutableSet.of(Permission.ALTER,
                                                                                   Permission.DROP,
                                                                                   Permission.AUTHORIZE);

...
public class PermissionsCache extends AuthCache<Pair<AuthenticatedUser, IResource>, Set<IPermission>> implements PermissionsCacheMBean
{
    ...
    public Set<IPermission> getPermissions(AuthenticatedUser user, IResource resource)
    {
        try
        {
